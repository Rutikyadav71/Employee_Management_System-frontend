...
const Dashboard = () => {
  ...
  const fetchStats = async () => {
    try {
      const empRes = await axios.get('https://springboot-ems-2004.up.railway.app/api/employees');
      const leaveRes = await axios.get('https://springboot-ems-2004.up.railway.app/api/leaves');
